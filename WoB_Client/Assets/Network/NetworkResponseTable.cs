...
public class NetworkResponseTable {
	...
	public static void init() {
		...
		add(Constants.SMSG_BATTLE_REQ, "ResponseBattleInit");
		add(Constants.SMSG_TILE_LIST,"ResponseTileList");
		add(Constants.SMSG_TILE,"ResponseTile");
		add(Constants.SMSG_SEASON_CHANGE,"ResponseSeasonChange");
		add(Constants.SMSG_WORLD,"ResponseWorld");
		add(Constants.SMSG_TILE_UPDATE, "ResponseTileUpdate");
		add(Constants.SMSG_TOPLIST, "ResponseTopList");
	}
