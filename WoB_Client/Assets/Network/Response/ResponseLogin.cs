...
public class ResponseLogin : NetworkResponse {
	...
	public override void parse() {
		...
		if (status == 0) {
			...
			tile_num = DataReader.ReadInt(dataStream);
			Debug.Log(user_id + " logs in");
			Debug.Log("Number of tils owned: " + tile_num);
		}
	}
