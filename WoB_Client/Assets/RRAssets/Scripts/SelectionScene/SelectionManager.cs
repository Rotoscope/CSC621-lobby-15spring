...
namespace RR {
    public class SelectionManager : MonoBehaviour {
    	...
    	void Start () {
    		...
    		mainObject.GetComponent<RRMessageQueue>().AddCallback(Constants.SMSG_RRSTARTGAME, ResponseRRStartGame);
			mainObject.GetComponent<RRMessageQueue>().AddCallback(Constants.SMSG_RRGETMAP, ResponseRRGetMap);
