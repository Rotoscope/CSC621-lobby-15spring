public class Constants {
	...
	//the city ftp setting
	//public static readonly string REMOTE_HOST = "130.212.3.51";
	//public static readonly int REMOTE_PORT = 9696;
	...
	//author: Lobby Team
	//world
	public static readonly short SMSG_WORLD = 237;
	//battle model
	public static readonly short CMSG_BATTLE_REQ = 132;
	public static readonly short SMSG_BATTLE_REQ = 232;
	public static readonly float BATTLE_REQUEST_RATE = 1f;
	// tile information
	public static readonly short CMSG_TILE_LIST = 134;
	public static readonly short SMSG_TILE_LIST = 234;
	public static readonly short CMSG_TILE = 135;
	public static readonly short SMSG_TILE = 235;
	public static readonly short CMSG_TILE_UPDATE = 138;
	public static readonly short SMSG_TILE_UPDATE = 238;
	//season change
	public static readonly short CMSG_SEASON_CHANGE = 136;
	public static readonly short SMSG_SEASON_CHANGE = 236;	
