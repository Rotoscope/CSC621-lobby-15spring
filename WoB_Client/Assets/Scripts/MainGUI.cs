...
public class MainGUI : MonoBehaviour {
	...
	void OnGUI() {
		if (!isHidden) {
			...
			windowRect = GUILayout.Window((int) Constants.GUI_ID.Login, windowRect, MakeWindow, username);
			windowRect2 = GUILayout.Window((int) Constants.GUI_ID.Species, windowRect2, MakeSpeciesGUI, "Species");
		}
	}
