...
public class Shop : MonoBehaviour {
	...
	void OnGUI() {
		if (!isHidden) {
						...
						windowRect = GUI.Window((int)Constants.GUI_ID.Shop, windowRect, ShopMakeWindow, "Shop");
				}
	...
	public void ResponseUpdateResources(ExtendedEventArgs eventArgs) {
		ResponseUpdateResourcesEventArgs args = eventArgs as ResponseUpdateResourcesEventArgs;
