...
public class BattlePlayer : MonoBehaviour {
	...
	public void createTree(){
		GameObject obj = (GameObject) Instantiate(Resources.Load("Prefabs/Battle/Tree 2"));
	...
	void Update () {
		Texture2D manaTexture = (Texture2D) Resources.Load ("Prefabs/Battle/mana"+(int)manaAnimate, typeof(Texture2D));
