...
//        add(Constants.CMSG_GET_FUNCTIONAL_PARAMETERS, "RequestGetFunctionalParameters");
        ...
        //battle model
        add(Constants.CMSG_BATTLE_INIT, "RequestBattleInit");
        // Tile information
        add(Constants.CMSG_TILE_LIST, "RequestTileList");
        add(Constants.CMSG_TILE, "RequestTile");
        add(Constants.CMSG_TILE_UPDATE, "RequestTileUpdate");
        add(Constants.CMSG_TOPLIST, "RequestTopList");
    }
