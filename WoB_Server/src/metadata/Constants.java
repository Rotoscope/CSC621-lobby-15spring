...
//    public final static short SMSG_DELETE_WORLD = 224;
    ...
    public final static short CMSG_TOPLIST = 132;
    public final static short SMSG_TOPLIST = 232;
    ...
    //author: lobby team
    //world
    public final static short SMSG_WORLD = 237;
    //default world setting
    public final static short GAMEMODE = 0;
    public final static String GAMENAME = "";
    public final static int MAXPLAYERS = 1;
    public final static String ENVTYPE = "Savanna";
    public final static short ACCESSTYPE = (short)1;
    
    //Battle
    public final static short CMSG_BATTLE_INIT = 132;
	public final static short SMSG_BATTLE_INIT = 232;
	
    //Season Change
    public final static short CMSG_SEASON_CHANGE = 136;
	public final static short SMSG_SEASON_CHANGE = 236;
	
	//Tile
	public final static int TOTAL_TILE_NUM = 42*42;
	public final static int TILE_NO_OWNER = 0;
    public final static short CMSG_TILE_LIST = 134;
    public final static short SMSG_TILE_LIST = 234;
    public final static short CMSG_TILE = 135;
    public final static short SMSG_TILE = 235;
    public final static short CMSG_TILE_UPDATE = 138;
    public final static short SMSG_TILE_UPDATE = 238;
